...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl relative rounded-br-2xl dark:bg-dark dark:border-light dark:text-light">
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Swagat | Articles Page</title>
